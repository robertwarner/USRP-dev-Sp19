...
# Title: Experiment
# Generated: Wed Apr 24 18:22:50 2019
##################################################
...
class experiment(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._freq_range = Range(300e6, 3e9, 1e6, 1e9, 200)
        ...
        self.CS499_numbers_0 = CS499.numbers()

        ##################################################
        # Connections
        ##################################################
        self.connect((self.CS499_numbers_0, 0), (self.blks2_packet_encoder_0, 0))
